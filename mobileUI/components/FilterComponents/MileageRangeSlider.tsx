// components/FilterComponents/MileageRangeSlider.tsx
...
export default function MileageRangeSlider({ min, max, values, onChange }: Props) {
  ...
  return (
    <View style={{ marginBottom: 36 }}>
      ...
      >
        {values[0].toLocaleString()} km – {values[1].toLocaleString()} km
      </Text>
