...
import {
  ...
  ImageIcon, LinkIcon, Minus, Undo2, Redo2, Eraser, Upload
} from 'lucide-react';
...
const GuideEditorToolbar = ({ editor }) => {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 p-3 rounded-xl bg-card/90 shadow-sm border border-muted backdrop-blur-lg w-full max-w-full">
      {/* Text formatting */}
...
export default GuideEditorToolbar;